...
public class Algorithm {
	...
	public int [] returnList= new int[4];// change to 8 for a 8X8 array.Currently 4X4
	public int []activeCordinates_x;
	public int []activeCordinates_y;
	public int[] hashed=new int[4];////^

	public  Algorithm(int[][] Array_penalties,int [][] ListC ) {
		Matrix1=Array_penalties;
		fullConstrains=ListC;
		valused=fullConstrains.length;
		activeList=new int[16-valused];// need to change for a 8x8 array to 64. currently doing 4x4 thats why its 16.
		activeCordinates_x=new int[16-valused];//^
		activeCordinates_y=new int[16-valused];//^
	}

	public int [] bloom(int len1) {
		int [] root=new int[4];// change to 8 for a 8x8. currently 4x4.
		int count=0;
		int index=0;
...
/////////////////////////////////////////////////////////////////////////////////	
	public void turnconstrains() {
		int core1=0;
		boolean flag1=true;
		for (int i=0;i<4;i++) {// change to 8 for a 8x8 matrix
			for(int j=0;j<4;j++) {//^
		...
		hashed=bloom(16-valused);// change to 64 for a 8x8 matrix.
	}
////////////////////////////////////////////////////////////////////////////////////				
}
